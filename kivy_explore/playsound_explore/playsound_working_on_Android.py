...
def main():
    songs = [
        '/storage/9016-4EF8/Audio/Various/Comment Etudier Un Cours En Miracles .mp3', # on S20
        '/storage/emulated/0/Music/Various/Comment Etudier Un Cours En Miracles .mp3' # on tablet
        ]
