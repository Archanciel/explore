...
class AppGUI(BoxLayout):
	...
	def spinnerValueSet(self, spinnerTextSet):
		initialText = self.ids.kivy_custom_class_fields_buttons.ids.first_text_input.text
		self.ids.kivy_custom_class_fields_buttons.ids.first_text_input.text = initialText + " " + spinnerTextSet
		print('AppGUI.spinnerValueSet() executed')
