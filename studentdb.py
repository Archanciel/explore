...
class StudentDB(BoxLayout):
    ...
    def studentSelected(self, instance):
        student = str(instance.text)
        firstN, lastN = student.split()

        self.first_name_text_input.text = firstN       
        self.last_name_text_input.text = lastN
